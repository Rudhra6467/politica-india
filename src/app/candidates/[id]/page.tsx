...
export default async function CandidatePage({
  ...
  return (
    <div className="-mx-4 -mt-8 min-h-screen bg-[#0b0d12] text-zinc-100 pb-16">
      <div className="mx-auto max-w-5xl px-4 sm:px-6 pt-6 space-y-5">
        <Link
          href="/candidates"
        ...
        {/* ========== WHITE METRIC CARDS (transparency) ========== */}
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
          <WhiteMetric label="Age" value={candidate.age?.toString() ?? "—"} />
          <WhiteMetric label="Education" value={candidate.education ?? "—"} />
          <WhiteMetric label="Declared Assets" value={candidate.totalAssets ?? "—"} accent />
          <WhiteMetric
        ...
        {/* ========== WHITE VERIFIED RECORD ========== */}
        <section className="rounded-2xl bg-white text-slate-900 overflow-hidden shadow-lg">
          <div className="flex items-center justify-between gap-3 px-5 py-4 border-b border-slate-100">
            <div className="flex items-center gap-2.5">
              <span className="h-2 w-2 rounded-full bg-blue-500" />
              <div>
                <h2 className="text-sm font-semibold tracking-wide">Verified Record</h2>
          ...
          {candidate.promises.length === 0 ? (
            ...
            <div className="space-y-3">
              {candidate.promises.map((p) => (
                <div key={p.id} className="rounded-2xl bg-white text-slate-900 overflow-hidden shadow-lg">
                  <div className="p-5">
        ...
        <p className="text-center text-[11px] text-zinc-600 leading-relaxed max-w-lg mx-auto pt-2">
...
function WhiteMetric({
  ...
  return (
    <div className="rounded-2xl bg-white px-4 py-4 shadow-lg">

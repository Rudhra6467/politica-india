...
export const pilotCandidates: PilotCandidate[] = [
  ...
  },
  {
    ...
    electionResult: "won", opponentName: "Duvvada Srinivas", opponentParty: "YSRCP", marginVotes: 34435,
  ...
  },
  {
    ...
    age: 51, education: "Graduate Professional (LLB)", profession: "Business (Naveena Rice Industries)",
    totalAssets: "₹10.8 Cr (2024 affidavit)", totalLiabilities: "₹1.8 Cr+", criminalCases: 15,
  ...
  },
  {
    ...
    electionResult: "won", opponentName: "Perada Tilak", opponentParty: "YSRCP", marginVotes: 327901,
  ...
  },
  {
    ...
    electionResult: "won", opponentName: "B.Tech Ravi (Mareddy Ravindranath Reddy)", opponentParty: "TDP", marginVotes: 61687,
  ...
  },
  {
    ...
    age: 48, education: "Graduate", profession: "Politician", totalAssets: "Unable to verify for pilot — Form 26 not yet mapped", criminalCases: 0,
    affidavitPdfUrl: "https://affidavit.eci.gov.in/", affidavitYear: "2024", lastUpdated: "2026-08-08", sortOrder: 2,
    likes: 980, dislikes: 340,
    promises: [{ id: "ap-p07", title: "Strengthen local health and education infrastructure", sourceNote: "Campaign 2024", announcedDate: "2024-04", status: "UNABLE_TO_VERIFY", evidenceNote: "Candidate lost the seat; tracking deferred.", lastChecked: "2026-08-16", likes: 420, dislikes: 95 }],
  },
  {
  ...
  },
  {
    ...
    age: 58, education: "Graduate", profession: "Politician", totalAssets: "Unable to verify for pilot — Form 26 not yet mapped", criminalCases: 0,
  ...
  },
  {
    ...
    age: 45, education: "Graduate", profession: "Politician", totalAssets: "Unable to verify for pilot — Form 26 not yet mapped", criminalCases: 0,
  ...
  },
  {
    ...
    promises: [
      ...
      { id: "ap-p17", title: "Curb illegal sand mining and protect environment", sourceNote: "Jana Sena public positions / campaign", announcedDate: "2024", status: "IN_PROGRESS", lastChecked: "2026-08-18", likes: 2100, dislikes: 310 },
    ],
  },
  {
    ...
    electionResult: "won", opponentName: "Annabathuni Siva Kumar", opponentParty: "YSRCP", marginVotes: 48112,
    ...
    affidavitPdfUrl: "https://affidavit.eci.gov.in/", affidavitYear: "2024", lastUpdated: "2026-08-24", sortOrder: 2,
    photoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/6/6d/Nadendla_Manohar_AP_Speaker.jpg/330px-Nadendla_Manohar_AP_Speaker.jpg",
    photoSource: "Wikimedia Commons",
  ...
  },
  {
    ...
    promises: [{ id: "ap-p13", title: "Urban civic issues and employment", sourceNote: "Campaign statements 2024", announcedDate: "2024-04", status: "UNABLE_TO_VERIFY", evidenceNote: "Insufficient independent progress reporting.", lastChecked: "2026-08-16", likes: 290, dislikes: 45 }],
  },
  {
  ...
  },
  {
    ...
    electionResult: "won", opponentName: "Dudi Srikanth Reddy", opponentParty: "BJP", marginVotes: 82308,
    ...
    affidavitPdfUrl: "https://affidavit.eci.gov.in/", affidavitYear: "2023", lastUpdated: "2026-08-24", sortOrder: 3,
    photoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/da/Harish_Rao_PROFILE.jpg/330px-Harish_Rao_PROFILE.jpg",
    photoSource: "Wikimedia Commons",
  ...
  },
  {
    ...
    electionResult: "won", opponentName: "Saidi Reddy Shanampudi", opponentParty: "BRS", marginVotes: 44888,
  ...
  },
  {
    ...
    electionResult: "lost", opponentName: "Padi Kaushik Reddy", opponentParty: "BRS", marginVotes: 16873,
    ...
    affidavitPdfUrl: "https://affidavit.eci.gov.in/", affidavitYear: "2023", lastUpdated: "2026-08-24", sortOrder: 3,
    photoUrl: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b7/Etela_Rajendera.jpg/330px-Etela_Rajendera.jpg",
    photoSource: "Wikimedia Commons",
  ...
  },
  {
    ...
    electionResult: "lost", opponentName: "M. Naveen Yadav", opponentParty: "BRS",
    age: 58, education: "Graduate Professional", profession: "Politician / Advocate",
    totalAssets: "₹17.1 Cr (2023 affidavit)", totalLiabilities: "₹7.4 Cr", criminalCases: 25,
    affidavitPdfUrl: "https://affidavit.eci.gov.in/", affidavitYear: "2023", lastUpdated: "2026-08-16", sortOrder: 4,
...
/** Leaders with photos — homepage visitor strip */
export function getFeaturedLeaders(limit = 8): PilotCandidate[] {
  const withPhoto = pilotCandidates
    .filter((c) => c.photoUrl && (c.sortOrder ?? 99) <= 3)
    .sort((a, b) => (a.sortOrder ?? 99) - (b.sortOrder ?? 99));
  const rest = pilotCandidates
    .filter((c) => c.photoUrl && !withPhoto.some((w) => w.id === c.id))
    .sort((a, b) => (a.sortOrder ?? 99) - (b.sortOrder ?? 99));
  return [...withPhoto, ...rest].slice(0, limit);
}
